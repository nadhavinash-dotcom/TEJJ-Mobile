        ...
        {isLoading ? (
          ...
          <>
            <View className="px-4 flex-row gap-3 mb-4">
              <StatCard icon="📋" label="Active Jobs" value={data?.active_jobs ?? 0} color="#3B82F6" />
              <StatCard icon="👥" label="Applicants" value={data?.total_applicants ?? 0} color="#F59E0B" />
              <StatCard icon="✅" label="Matches Today" value={data?.matches_today ?? 0} color="#22C55E" />
            </View>
